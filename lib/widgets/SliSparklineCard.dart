...
class SliSparklineCardV2 extends StatelessWidget {
  SliSparklineCardV2(
      {Key? key,
      required this.sli,
      required this.name,
  ...
  Widget build(BuildContext context) {
    ...
    print("LENGTH " +
        ((controller.sparkLines[sli]?.length ?? 0) < index).toString());
    return Card(
        ...
        child: InkWell(onTap: () {
          ...
          List<double> data = (controller.sparkLines[sli]?.length ?? 0) <= index
              ? []
